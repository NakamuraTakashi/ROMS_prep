...
gfile='../../Projects/Kushimoto/Kushimoto_grd_v0.1.nc';
ofile='D:/COAWST_DATA/Kushimoto/Tide/Kushimoto_tide_tpxo9_atlas30_20100101.nc';

base_date=datenum(2000,1,1);
pred_date=datenum(2010,1,1);
...
otps2frc_v5_tpxo9_atlas30(gfile,base_date,pred_date,ofile,model_dir,'Kushimoto')