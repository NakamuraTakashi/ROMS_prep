...
In this directory, the simuration data estimated from MATSIRO and CaMa-Flood
Variables are available in near-real-time. 

********************************************************************************
# Contents
  1. Versions of Today’s Earth 
  2. Available variables
  3. Structure of FTP Directories
  4. File Naming Convention
  5. Format
  6. How to distinguish between analytic and predicted values
  7. Documents
  8. References
...
./TE-japan/
 ...
 yyyy: 4-digit year calculation start time (timeline);
...
# TE-japan:
 ...
 rrr: 3 characters representing spatial resolution
      (e.g. '01M' means 1 min. lat/lon resolution)
 eee: 3 characters representing experient name
      (e.g. 'MSM' means MSM/GPV ver.)
 yyyy: 4-digit year calculation start time (timeline);
 mm: 2-digit month of timeline;
 dd: 2-digit day of timeline;
 xxxx: Valiable name
...
********************************************************************************
# 5. Format
  All data is in NetCDF4 format and compressed with gzip.


********************************************************************************
# 6.  How to distinguish between analytic and predicted values(MSM ver.)

For precipitation used in MSM/GPV ver., JMA’s in-situ and ground radar based rainfall (Radar-AMeDAS) 
is used up to the current time, and the forecast is based on the 39-hour forecast from 
the JMA meso-scale numerical model GPV (MSM) corrected by machine learning (see Section 2.1 for details). 
To distinguish between the two, check "rain_forcing" in the global_attributes of the netCDF file 
("rain_forcing = amedas" indicates that the Radar-AMeDAS was entered and "rain_forcing = msm" is 
the result of entering the corrected 39-hour forecast). 
"rain_forcing” is included in the products after May 11, 2022.

*All data prior to February 28, 2022 are based on the JMA Meso-scale numerical model GPV (MSM) reanalysis.

********************************************************************************
# 7. Documents

# TE-japan: Brief Description & Validation Report
