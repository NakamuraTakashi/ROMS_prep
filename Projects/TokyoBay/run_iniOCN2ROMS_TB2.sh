...
case ${gen_mode} in
  ini) MODE_FLAG="-DINI_MODE"; EXE=prepOCN2ROMS_ini.exe ;;
  bry) MODE_FLAG="-DBRY_MODE"; EXE=prepOCN2ROMS_bry.exe ;;
  his) MODE_FLAG="-DHIS_MODE"; EXE=prepOCN2ROMS_his.exe ;;
...
# ----- Compile -----
gfortran -fbounds-check -fno-align-commons \
  ...
  ${MY_CPP_FLAGS} -fopenmp -O2 -I/usr/include -L/usr/lib -lnetcdff -o ${EXE} || { echo "Compile failed"; exit 1; }
