...
DATADIR=../../../COAWST_DATA/TokyoBay
SRC_GRID=${DATADIR}/TokyoBay2/Grid/TokyoBay2_grd_v2.1.nc
DST_GRID=${DATADIR}/TokyoBay3/Grid/TokyoBay3_grd_v2.1.nc

INPUT_GLOB="TokyoBay2_frc_MSMgb_*.nc"   # forcing files to convert (on TokyoBay2 grid)
SRC_TAG="TokyoBay2"                       # replaced by DST_TAG to build output names
DST_TAG="TokyoBay3"
