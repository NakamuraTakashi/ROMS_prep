...
!----------------------------------------------------------------------
     ...
     &       "0000_CWM_GPV_Rjp_Gll0p05deg_FD0000-0300_grib2.bin"
      character(11) :: OUT_suffix    = "_201701.txt"
...
!---- Read JMA CWM GRIB2 file --------------------------------
      ...
      GRIB_FILE = GRIB_dir//GRIB_prefix//GRIB_yyyymmddhh//GRIB_suffix
      !Open GRIB file
...
!---- LOOP1 START --------------------------------
      ...
      DO
        ...
        write (DD, "(I2.2)") 1+int((itime-1)*6/24)
        write (hh, "(I2.2)") mod((itime-1)*6,24)
...
!----   LOOP2 START --------------------------------
        DO iparam=1,2
          ...
          write(* , "(I8.8 '.' I4.4 f9.3 f9.3 f9.3)") YYYYMMDD, hhmm, Hs, Tp, Dp
          write(20, "(I8.8 '.' I4.4 f9.3 f9.3 f9.3)") YYYYMMDD, hhmm, Hs, Tp, Dp
