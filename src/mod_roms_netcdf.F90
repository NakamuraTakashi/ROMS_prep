...
!---- Create the ROMS grid netCDF file --------------------------------
    ...
    ! Define the netCDF variables.
      ...
      call check( nf90_def_var(ncid, 'p_coral_01', NF90_DOUBLE, dim2Dids, var_id) )
      call check( nf90_put_att(ncid, var_id, 'long_name', 'coral_01 coverage') )
      call check( nf90_put_att(ncid, var_id, 'units',     '0 to 1') )
      call check( nf90_def_var(ncid, 'p_coral_02', NF90_DOUBLE, dim2Dids, var_id) )
      call check( nf90_put_att(ncid, var_id, 'long_name', 'coral_02 coverage') )
      call check( nf90_put_att(ncid, var_id, 'units',     '0 to 1') )
      call check( nf90_def_var(ncid, 'p_algae_01', NF90_DOUBLE, dim2Dids, var_id) )
      call check( nf90_put_att(ncid, var_id, 'long_name', 'algal_01 coverage') )
      call check( nf90_put_att(ncid, var_id, 'units',     '0 to 1') )
      call check( nf90_def_var(ncid, 'p_sgrass_01', NF90_DOUBLE, dim2Dids, var_id) )
      call check( nf90_put_att(ncid, var_id, 'long_name', 'seagrass_01 coverage') )
      call check( nf90_put_att(ncid, var_id, 'units',     '0 to 1') )
...
!**** readNetCDF_3d ver 2 **********************************************
  ...
  SUBROUTINE readNetCDF_3d_hycom2(    &
!    input parameters
        NCFILE                        &
      , ncid                          &
      , NCNAME                        &
...
!      if (status == nf90_noerr .and. data(Im,Jm,Nt)/=-9999.0d0) then
  ...
  END SUBROUTINE readNetCDF_3d_hycom2
...
!**** readNetCDF_4d ver 2 **********************************************
  ...
  SUBROUTINE readNetCDF_4d_hycom2(    &
!    input parameters
        NCFILE                        &
      , ncid                          &
      , NCNAME                        &
...
!        if (status == nf90_noerr .and. data(Nxr,Nyr,k,Nt)/=-9999.0d0) then
  ...
  END SUBROUTINE readNetCDF_4d_hycom2
